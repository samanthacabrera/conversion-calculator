...
const Footer = () => {
  return (
      <>
      {/* <p>At <span>Calcalooza</span>, we believe that everyone should have access to free resources, so all our tools are completely free to use for everyone, and no registration is needed.
