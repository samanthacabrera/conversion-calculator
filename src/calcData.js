export const calcData = {
    ...
    ExponentCalculators: {
        basicExponent: {
            calcType: "basicExponent",
            label: "Basic Exponent",
            color: "pink",
            desc: "Calculates the result of raising a base to a power.",
            formula: "a^b",
            calculate: (base, exponent) => Math.pow(base, exponent),
            steps: [
                "Identify the base (a) and the exponent (b).",
                "Write down the formula: a^b.",
                "Raise the base to the power of the exponent to get the result."
            ],
            dimensions: [
                { name: "Base", definition: "The number being raised to a power." },
                { name: "Exponent", definition: "The power to which the base is raised." }
            ],
            wordProblem: "What is 3 raised to the power of 4?",
            units: {},
        },
        fractionalExponent: {
            calcType: "fractionalExponent",
            label: "Fractional Exponent",
            color: "lime",
            desc: "Calculates the result of raising a base to a fractional power.",
            formula: "a^(m/n)",
            calculate: (base, numerator, denominator) => Math.pow(base, numerator / denominator),
            steps: [
                "Identify the base (a) and the fraction (m/n).",
                "Write down the formula: a^(m/n).",
                "Raise the base to the power of the fraction to get the result."
            ],
            dimensions: [
                { name: "Base", definition: "The number being raised to a power." },
                { name: "Numerator", definition: "The numerator of the fractional exponent." },
                { name: "Denominator", definition: "The denominator of the fractional exponent." }
            ],
            wordProblem: "What is 16 raised to the power of 1/2?",
            units: {},
        },
        negativeExponent: {
            calcType: "negativeExponent",
            label: "Negative Exponent",
            color: "sky",
            desc: "Calculates the result of raising a base to a negative power.",
            formula: "a^(-b)",
            calculate: (base, exponent) => Math.pow(base, -exponent),
            steps: [
                "Identify the base (a) and the negative exponent (b).",
                "Write down the formula: a^(-b).",
                "Calculate the reciprocal of the base raised to the positive exponent to get the result."
            ],
            dimensions: [
                { name: "Base", definition: "The number being raised to a power." },
                { name: "Exponent", definition: "The negative power to which the base is raised." }
            ],
            wordProblem: "What is 2 raised to the power of -3?",
            units: {},
        },
        squareRoot: {
            calcType: "squareRoot",
            ...
            formula: "√a",
            calculate: (number) => Math.sqrt(number),
            steps: [
                "Identify the number (a) you want to find the square root of.",
                "Write down the formula: √a.",
                "Calculate the square root of the number to get the result."
            ],
            dimensions: [
                { name: "Number", definition: "The value for which you want to find the square root." }
            ],
            wordProblem: "What is the square root of 49?",
            units: {},
        },
        nthRoot: {
            calcType: "nthRoot",
            label: "Nth Root",
            color: "purple",
            desc: "Calculates the nth root of a number.",
            formula: "a^(1/n)",
            calculate: (number, n) => Math.pow(number, 1 / n),
            steps: [
                "Identify the number (a) and the root (n) you want to calculate.",
                "Write down the formula: a^(1/n).",
                "Calculate the nth root of the number to get the result."
            ],
            dimensions: [
                { name: "Number", definition: "The value for which you want to find the nth root." },
                { name: "Root", definition: "The degree of the root you want to calculate." }
            ],
            wordProblem: "What is the cube root of 27?",
            units: {},
        }
    },
